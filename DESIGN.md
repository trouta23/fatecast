...
3.  **Plugin System:** [COMPLETED] Refactor `DiceEngine` to use a plugin pattern for supporting diverse dice types (`dF`, `d%`). Implemented `DaggerheartDiceRule` and `FudgeDiceRule`.
